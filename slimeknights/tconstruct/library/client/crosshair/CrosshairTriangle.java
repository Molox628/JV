...
{
    public CrosshairTriangle(final ResourceLocation texture) {
        this(texture, 16);
    }
    
    public CrosshairTriangle(final ResourceLocation texture, final int size) {
        super(texture, size);
    }
    ...
    private void drawTipCrosshairPart(final double x, final double y, final int part) {
        ...
        if (part == 0) {
            ...
            vb.func_181662_b(x, y, -90.0).func_187315_a(0.5, 0.5).func_181675_d();
            vb.func_181662_b(x + 8.0, y - 8.0, -90.0).func_187315_a(1.0, 0.0).func_181675_d();
        }
        else if (part == 1) {
            vb.func_181662_b(x - 8.0, y - 8.0, -90.0).func_187315_a(0.0, 0.0).func_181675_d();
            vb.func_181662_b(x - 8.0, y + 8.0, -90.0).func_187315_a(0.0, 1.0).func_181675_d();
            vb.func_181662_b(x, y, -90.0).func_187315_a(0.5, 0.5).func_181675_d();
        }
        else if (part == 2) {
            vb.func_181662_b(x, y, -90.0).func_187315_a(0.5, 0.5).func_181675_d();
            vb.func_181662_b(x + 8.0, y + 8.0, -90.0).func_187315_a(1.0, 1.0).func_181675_d();
            vb.func_181662_b(x + 8.0, y - 8.0, -90.0).func_187315_a(1.0, 0.0).func_181675_d();
        }
        else if (part == 3) {
            vb.func_181662_b(x, y, -90.0).func_187315_a(0.5, 0.5).func_181675_d();
